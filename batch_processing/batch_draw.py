...
# for i, dir in enumerate(dirpath_list):
#     print(i)
#     print(':' + dir)
...
for j, path in enumerate(path_list):
    ...
    for i in range(df.shape[1]//6):
        ...
        mkpath = dirpath_list[0] + '/fig_save'
        ...
        # plt.show() # 每张图挨个输出
        fig1.savefig(mkpath + '/' + filepath_list[j] + '-A&W-' + str(index_list[i]) + '.png')
        fig2.savefig(mkpath + '/' + filepath_list[j] + '-XYZ-' + str(index_list[i]) + '.png')
